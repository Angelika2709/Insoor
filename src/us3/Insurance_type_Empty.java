...
class Insurance_type_Empty {
	private static Precondition_req_new pr;
	private static Request_new_Controls req_contr = new Request_new_Controls();
	...
	void test() {
		...
		/*->*/ req_contr.field_ins_types.sendKeys(Request_new_Controls.types[0]);
		req_contr.get_data();
		...
		WebElement error = wait1
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//form[@id='form-offer-add']/div/div[4]/div/p")));
