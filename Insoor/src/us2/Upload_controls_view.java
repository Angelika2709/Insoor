...
public class Upload_controls_view extends Precondition_policy_view {
	...
	public WebElement field_insur, field_ins_types_pol, field_price, beg_per, end_per, sub_but;
	...
	public void get_ins_types() {
		Select dropdown_ins_types = new Select(
				driver.findElement(By.xpath("//*[@id=\"userinsurancetypecompany-insurance_type_id\"]")));
		...
		field_ins_types_pol = driver.findElement(
	...
	public void get_insur() {
		Select dropdown_insur = new Select(
				driver.findElement(By.xpath("//*[@id=\"userinsurancetypecompany-company_id\"]")));
		...
		field_insur = driver
				.findElement(By.xpath("//*/form/div/div[3]/div/select[@id=\"userinsurancetypecompany-company_id\"]"));
	}
	...
	public String view_card() {
		List<WebElement> cardslist = driver
				.findElements(By.cssSelector("a[class='view__policy btn btn-link contract-card__policy pull-right']"));
		for (WebElement card : cardslist)
			cardslist.get(0).getAttribute("data-pp-title");
		return title = cardslist.get(0).getAttribute("data-pp-title");
